const platformData = {
  heroSlides: [
    ...
    // },
      {
        title: "电网巡检",
        text: "覆盖设备缺陷、通道异物、烟雾火情等场景，支撑巡检自动化与智能识别。",
        image: "./效果图/轮播/电网巡检.jpg",
      },
      {
        title: "农林植保",
        text: "聚焦作物长势、病虫害识别与区域分析，提升农林监测精度与效率。",
        image: "./效果图/轮播/农林植保.png",
      },
      {
        title: "应急救援",
        text: "面向灾害场景人员搜救与风险识别，支持复杂环境下的快速响应。",
        image: "./效果图/轮播/应急救援.jpg",
      },
      {
        title: "城市管理",
        text: "覆盖交通监测、违章识别与市容巡检，助力城市治理精细化运行。",
